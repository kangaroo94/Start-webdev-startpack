# Start-webdev-startpack
 Сборка Gulp4 + webpack с плагинами для разработки Frontend

 <div align="center">
  <a href="https://github.com/webpack/webpack">
    <img width="400" height="200" src="template.jpg">
  </a>
  <br>
  <br>
  <h1>Start-webdev-startpack</h1>

![GitHub release (latest by date)](https://img.shields.io/github/v/release/budfy/Easy-webdev-startpack?style=plastic)
...
<hr>
<br>
Необходимо иметь следующие установленные инструменты:
